...
android {
    ...
    // v0.3.1, publishes AAR metadata demanding API 37 or later. That in turn
    // needs AGP > 9.1.0, which needs Gradle >= 9.5.0 -- see settings.gradle.kts
    // and gradle-wrapper.properties, bumped in the same commit.
    compileSdk = 37
    ...
    defaultConfig {
        ...
        applicationId = "com.kuhy.lyricanki"
    ...
    buildTypes {
        release {
            ...
            // CI re-checks the signature afterwards and refuses to publish a
            // debug-signed APK -- which is what caught this being unset.
