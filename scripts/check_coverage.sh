...
#
# Copied from utils/design_system. lyricanki enforces 100% line coverage as a
# hard gate (not a convention): it runs from ci_mirror.sh and from CI, so an
# uncovered line fails the build rather than being noticed later.
#
